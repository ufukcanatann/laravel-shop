                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @if($setting->map_listings == 1)
                            <li><a href="{{ route('map-listings') }}">Haritaları Listele <i class="fa fa-map-marker"></i></a></li>
                        @endif

                        @if(Auth::guest())
                            <li><a href="{{route('login')}}" class="btn btn-link btn-auth font-15"><i class="icon-login"></i> Oturum Aç </a></li>
                            <li> &nbsp;</li>
                            <li><a href="{{route('register')}}" class="btn btn-link btn-auth font-15"><i class="icon-user-add"></i> Kayıt Ol </a></li>
                        @else
                        <li class="dropdown">
                        ...
                        @endif
                        <li class="postadd"><a class="btn btn-block   btn-border btn-post btn-danger" href="{{route('ads.create')}}">Ücretsiz İlan Ver
                            <img src="{{ asset('assets/img/cam.png') }}" alt="camera" height="18x"></a>
                        </li>
