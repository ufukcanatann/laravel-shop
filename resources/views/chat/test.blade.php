...
<div id="chat">
    <div class="panel panel-primary">
        ...
        <div class="panel-heading p-3-6">
            <span class="font-20"><span class="fa fa-wechat"></span> Canlı Sohbet  </span><i class="badge hidden chat_notIf">0</i>
        </div>
        <div class="panel-body chat-panel hidden" style="padding: 0px 2px 0 3px;">
            <div class="setting-container hidden" style="color: black">
                ...
                <span class="pull-left"> &nbsp; Kullanıcıları engelle </span>
                ...
                $.post(
                    ...
                    function (data) {
                        if (data !=0 ) {
                            ...
                            $('#chat .chat').html('<center> Henüz sohbet yok </center>');
                        }
                    }
                );
            }else{
