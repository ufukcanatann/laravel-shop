...
<!-- Contact List in Left-->
 <a href="{{route('chat.create')}}">sohbet sayfasını test et</a>
 <div class="card-box">
<ul class="nav nav-pills">
<li class="active"><a data-toggle="pill" href="#inboxed">Gelen kutusu</a></li>
 <li><a data-toggle="pill" href="#send">Gönderildi</a>
   </li>
 </ul>
...
<input id="chat_head" type="hidden" class="chathead" data-for="">
 ...
 <p class="inbox-item-author">{{ ucwords($value->name) }}
                                                                ...
                                                                <p class="inbox-item-text">Hey oradaki! Ben müsaitim.</p>
                                                                <p class="inbox-item-date">{{ date('h:i A', strtotime($value->created_at)) }}</p>
                                                            </div>
                                                        </a>
                                                    @endforeach
                                                @else
                                                    <p class="text-danger">Gelen kutusu boş. Henüz mesaj almadınız! </p>
                                                @endif
                                            </div>
                                        </div>
...
<input id="chat_head" type="hidden" class="chathead" data-for="">
 ...
 <p class="inbox-item-author">{{ ucwords($value->name) }}
                                                    ...
                                                    @endforeach
                                                @else
                         <p class="text-danger">Gönderilenler boş.
                            Henüz mesaj göndermediniz! </p>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <!-- CHAT -->
                                <div class="card-box">
                                    <h4 class="m-t-0 m-b-20 header-title"><b>Sohbet</b>
            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="modelTitleId">İfade Ekle</h4>
                    </div>
