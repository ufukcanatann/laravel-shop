            ...
            <div class="row">
                ...
                <div class="col-sm-9 page-content col-thin-left m-t-10">
                                                   ...
                                                   <div class="item-list make-grid m-b-20" style="background: #ececec;min-height: 366px;">
                                                       ...
                                                       <div class="col-md-3 text-right  price-box">
                                                           ...
                                                           @if(isset($v->user->is_verified) && $v->user->is_verified==2)
                                                               <a class="btn bg-white  btn-sm btn-auths" > <img src="{{ asset('assets/img/vfy.png') }}" title="Verified user" alt="" height="22px"> <span>Doğrulanmış kullanıcı</span> </a>
                                                           @endif
                    ...
                    <div class="post-promo text-center">
                        ...
                        <a href="{{route('ads.create')}}" class="btn btn-lg btn-border btn-post btn-danger">Ücretsiz İlan Ver </a>
                    </div>
                </div>
                <!--end -->
                    ...
                    <aside>
                        <div class="row inner-box">
                            ...
                            <div class="form-group">
                                <label for="price_range" class=" control-label"><b>Fiyat ({{$setting->currency}})</b><span class="font-normal text-muted f-s-12 clearfix"></span></label>
                                <div class="">
                                ...
                                <div class="form-group">
                                    <label for="sortbyprice" class=" control-label">Fiyata göre sırala</label>
                            ...
                            @endif
                            <div class="form-group">
                                <label for="online" class="">Kullanıcı Çevrimiçi / Çevrimdışı</label>
                                <select name="online" id="" class="form-control" form="search_form">
                                    <option @if( $online == '') selected @endif  value="">Tümü</option>
                                    <option @if( $online == 1) selected @endif  value="1">Çevrimiçi</option>
                                    <option @if( $online == 2 ) selected @endif  value="2">Çevrimdışı</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="img">
