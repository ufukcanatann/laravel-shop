                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}" autocomplete="off">
                        ...
                        <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
                            <div class="col-md-12">
                                <label for="type" class="control-label">Kullanıcı Türü:</label>
                                <div class="input-icon"><i class="icon-users fa"></i>
                                    <select id="type" type="type" class="form-control" name="type" value="{{ old('type') }}" required autocomplete="off">
                                        <option value="">Kullanıcı türünü seçin</option>
                                        <option {{ (old('type') == 'u')? 'selected' : '' }} value="u">Özel kullanıcı</option>
                                        <option {{ (old('type') == 'c')? 'selected' : '' }} value="c">Kurumsal</option>
                                    </select>
                                </div>
                                @if ($errors->has('type'))
                                    <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}" style="margin-bottom: -15px">
                            <div class="col-md-12">
                                <label for="gender" class="control-label">Cinsiyet:</label><br>
                                <label for="male">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <label for="password-confirm" class="control-label">Parolayı Doğrula:</label>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <a class="pull-right" href="{{route('login')}}"> Zaten kayıtlı mısın? </a>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class=" col-md-4 bg-white p-20">
            ...
            <div class="b-registration-info-container">
                <div class="b-registration-info">
                    <div class="b-registration-info-title"> Kaydolmanın avantajları </div>
                    <div class="b-registration-info-text">
                        {{ $setting->title }} ilanlarınızı kolay ve hızlı bir şekilde yönetmek için tasarlanmış ücretsiz bir hizmettir.
                        <ul class="b-rounded-list">
                            ...
                            <li>
                                ...
                                <div class="b-rounded-list-content">
                                    ...
                                    <p>İlanlarınızın performansını, ziyaret sayısını ve yanıtları analiz edin</p>
                                </div>
                            </li>
                            <li class="b-last">
                                <div class="b-rounded-list-pointer">
