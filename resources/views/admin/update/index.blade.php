                    ...
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            ...
                            <ol class="breadcrumb p-0 m-0">
                                ...
                                <li class="active"> Sürümü Güncelle</li>
                            </ol>
                    ...
                    <div class="col-md-12 col-xs-12 col-xxs-12">
                        <div class="panel panel-color panel-inverse">
                            <div class="panel-heading">
                                <h3 class="panel-title">Sürümü Güncelle</h3>
                            </div>
                            <div class="panel-body">
                                <button class="btn btn-info pull-right"> Sürüm  <?php //$ver = \Session::get('up_version'); //echo $ver->version;  ?> &nbsp;  <span class="badge badge-danger pull-right"> New</span></button>
                                <button class="btn btn-default pull-right">Şimdiki sürümü {{ $setting->version }} </button>
                                <div class="clearfix"></div>
