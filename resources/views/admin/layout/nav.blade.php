                        ...
                        <li>
                            <a href="{{ route('logout') }}"
                               onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                <i class="ti-power-off m-r-5"></i> Çıkış Yap
                            </a>
    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            ...
            <ul>
                ...
                <li><a href="{{ url('users') }}" class="waves-effect"><i class="fa fa-users"></i><span> Kullanıcıları Yönet</span> </a></li>
                <li><a href="{{ route('ads.index') }}" class="waves-effect"><i class="fa fa-tv" aria-hidden="true"></i><span> İlanlar</span> </a></li>

                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-file"></i> <span>Özel Sayfalar</span> <span class="menu-arrow"></span></a>
                    <ul class="list-unstyled">
                        <li><a href="{{ route('custom-page.index') }}">Sayfa Oluştur</a></li>
                        <li><a href="{{ route('custom-page.create') }}">Sayfaları Yönet</a></li>
                ...
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="{!! Route('setting.create') !!}">Ağ Ayarları</a></li>
                        <li><a href="{!! Route('setting.index') !!}">Ağ Reklamları</a></li>
                        <li><a href="{!! Route('email-settings.index') !!}">E-Postalar</a></li>
                        <li><a href="{!! Route('featured-ads.index') !!}">Öne Çıkan İlanlar</a></li>
                        @if($setting->mobile_verify == 1)
                        <li><a href="{!! Route('mobile_verify.index') !!}">Mobil Doğrulama</a></li>
                        @endif
                    </ul>
                </li>
                ...
                <li class="has_sub">
                 ...
                 <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="{{ url('region') }}" class="waves-effect"><i class="fa fa-plus"></i><span>Bölge</span> </a></li>
                        <li><a href="{{ url('city') }}" class="waves-effect"><i class="fa fa-plus"></i><span>Şehir</span> </a></li>
                    </ul>
                </li>
                <!-- Custom Fields -->
                <li><a href="{{ url('customfields') }}" class="waves-effect"><i class="fa fa-list"></i><span>Özel Alanlar</span></a></li>
            </ul>
        </div>
        <!-- Sidebar -->
