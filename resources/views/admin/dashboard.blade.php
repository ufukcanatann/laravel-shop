    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="alert alert-warning">
            <p><strong>Lütfen <a href="{!! Route('email-settings.index') !!}">e-posta ayarlarınızı</a> yapılandırınız</strong></p>
        </div>
      @endif
        ...
        <div class="col-lg-3 col-md-6">
          <div class="card-box widget-box-two widget-two-info">
            ...
            <div class="wigdet-two-content text-white">
              <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="Statistics">Kullanıcılar</p>
              <h2 class="text-white"><span data-plugin="counterup">{{ $total_user }}</span> <small><i class="mdi mdi-arrow-up text-success"></i></small></h2>
              <p class="m-0"><b>Bugün:</b> {{ $today_user }}</p>
            </div>
          </div>
        </div><!-- end col -->
        <div class="col-lg-3 col-md-6">
          <div class="card-box widget-box-two widget-two-primary">
            ...
            <div class="wigdet-two-content text-white">
              <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">İlanlar</p>
              <h2 class="text-white"><span data-plugin="counterup">{{ $total_ads }}</span> <small><i class="mdi mdi-arrow-up text-success"></i></small></h2>
              <p class="m-0"><b>Bugün:</b> {{ $today_ads }}</p>
            </div>
          </div>
        </div><!-- end col -->
          ...
          <div class="col-lg-3 col-md-6">
            <div class="card-box widget-box-two widget-two-brown">
              ...
              <div class="wigdet-two-content text-white">
                <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">Mesajlar</p>
                ...
                <p class="m-0"><b>Bugün:</b> {{ $today_messages }}</p>
              </div>
            </div>
          </div><!-- end col -->
          ...
          <div class="col-lg-3 col-md-6">
            <div class="card-box widget-box-two widget-two-pink">
              ...
              <div class="wigdet-two-content text-white">
                <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">Kayıtlı İlanlar</p>
                ...
                <p class="m-0"><b>Bugün:</b> {{ $today_save_ads }}</p>
              </div>
            </div>
          </div><!-- end col -->
