            ...
            <div class="col-xs-12">
                <div class="page-title-box">
                    ...
                    <ol class="breadcrumb p-0 m-0">
                        <li> <a href="{{ url('/home') }}">Kontrol Paneli</a></li>
                        <li class="active"> E-Posta Ayarları </li>
                    </ol>
                    ...
                    <div class="row">
                        <div class="panel panel-color panel-inverse">
                            <div class="panel-heading">
                                <h3 class="panel-title">E-Posta Ayarları</h3>
                            </div>
                            <div class="panel-body">
                                <div class="alert alert-info"> Posta Ayarları </div>
                                <form action="" method="post" id="EmailSettings" autocomplete="off">
                                    {{ csrf_field() }}
                                    <div class="form-group col-md-6">
                                        <label for=""> UYGULAMA ADI </label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for=""> POSTA ADRES ADI </label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for=""> POSTA GÖNDEREN ADI </label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for=""> POSTA KULLANICI ADI </label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for=""> POSTA ŞİFRELEME </label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for=""> TEST EPOSTASI </label>
                                        <input type="email" class="form-control" name="email" id="test_email" placeholder="Test e-posta kimliğini girin" required  autocomplete="off"/>
                                        <small>  </small>
                                    </div>
                                    <div class="clearfix"></div>
                                ...
                                <div class="col-md-12">
                                    <form class="form-horizontal" role="form" id="email_settings" >
                                        ...
                                        <div class="form-group">
                                            <div class="alert alert-info">Misafir Kayıt Bildirimi</div>
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label">Konu:</label>
                                            <input id="registration_subject" name="registration_subject" placeholder="Konu giriniz " value="{!! (isset($data->registration_subject)) ? $data->registration_subject : '' !!}" class="form-control" required autocomplete="off" >
                                        </div>

                                        <div class="form-group ">
                                            <label class="control-label">İçerik:</label>

                                            <textarea class="form-control" id="registration_content" rows="5" placeholder="Detay giriniz" > {!! (isset($data->registration_content)) ? $data->registration_content : '' !!}</textarea>
                                            <div class="register">
                                        ...
                                        <div class="form-group">
                                            <div class="alert alert-info">Durum Bildirimi</div>
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label">Konu:</label>
                                            <input id="status_subject" name="status_subject" placeholder="Konu giriniz " value="{!! (isset($data->status_subject)) ? $data->status_subject : '' !!}" class="form-control" autocomplete="off" >
                                        </div>

                                        <div class="form-group ">
                                            <label class="control-label">İçerik:</label>
                                            <textarea class="form-control" id="status_content" rows="5" placeholder="Detay giriniz" > {!! (isset($data->status_content)) ? $data->status_content : '' !!}</textarea>
                                            <div class="status">
                                                <a href="javascript:void(0)"> <span class="label label-success"> %name% </span> </a>
                                                <a href="javascript:void(0)"> <span class="label label-info"> %email% </span> </a>
                                                <a href="javascript:void(0)"> <span class="label label-danger"> %password% </span> </a>
                                        ...
                                        <!-- Identity Verified  -->
                                        <div class="form-group">
                                            <div class="alert alert-success">Doğrulanmış Kimlik Bildirimi</div>
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label">Konu:</label>
                                            <input id="status_subject" name="verify_success_subject" placeholder="Konu giriniz " value="{!! (isset($data->verify_success_subject)) ? $data->verify_success_subject : '' !!}" class="form-control" autocomplete="off" >
                                        </div>

                                        <div class="form-group ">
                                            <label class="control-label">İçerik:</label>
                                            <textarea class="form-control" id="verify_success" rows="5" placeholder="Detay giriniz" > {!! (isset($data->verify_success_content)) ? $data->verify_success_content : '' !!}</textarea>
                                        ...
                                        <div class="form-group">
                                            <div class="alert alert-danger">Doğrulanmamış Kimlik Bildirimi</div>
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label">Konu:</label>
                                            <input id="status_subject" name="verify_danger_subject" placeholder="Konu giriniz" value="{!! (isset($data->verify_danger_subject)) ? $data->verify_danger_subject : '' !!}" class="form-control" autocomplete="off" >
                                        </div>

                                        <div class="form-group ">
                                            <label class="control-label">İçerik:</label>
                                            <textarea class="form-control" id="verify_danger" rows="5" placeholder="Detay giriniz" > {!! (isset($data->verify_danger_content)) ? $data->verify_danger_content : '' !!}</textarea>
                                      ...
                                      <!-- Expiry  -->
                                        <div class="form-group">
                                            <div class="alert alert-danger"> Sona Eren İlan Bildirimi </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label">Konu:</label>
                                            <input id="status_subject" name="expiry_ads_subject" placeholder="Konu giriniz" value="{!! (isset($data->expiry_ads_subject)) ? $data->expiry_ads_subject : '' !!}" class="form-control" autocomplete="off" >
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label">İçerik:</label>
                                            <textarea class="form-control" id="expiry_ads" rows="5" placeholder="Detay giriniz" > {!! (isset($data->expiry_ads_content)) ? $data->expiry_ads_content : '' !!}</textarea>
