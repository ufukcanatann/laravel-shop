        ...
        <div class="content">
            ...
            <div class="col-xs-12">
                <div class="page-title-box">
                    <h4 class="page-title">Özel Alanlar</h4>
                    <ol class="breadcrumb p-0 m-0">
                        <li> <a href="{{ url('dashboard') }}">Kontrol Paneli</a></li>
                        <li class="active">Özel Alanlar</li>
                    </ol>
                ...
                <div class="card-box">
                    <div class="row">
						<div class="btn-group pull-right m-b-10">
                            <button id="add_cfield" type="button" class="btn btn-primary waves-effect waves-light" aria-expanded="false">Özel Alan Ekle</button>

                            <ul class="dropdown-menu">
                                <li onclick=" $('#catForm').submit()"><a href="javascript:void(0);"><i class="fa fa-trash" aria-hidden="true"></i> Öğe Sil  </a> </li>
                            </ul>
                        </div>
                                            		...
                                            		<fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="radio radio-info radio-inline">
                                                                ...
                                                                <label for="is_icon_{{ $customfield['id'] }}">Simge Ekle</label>
                                                            </div>
                                                            <div class="radio radio-inline">
                                                                ...
                                                                <label for="is_image_{{ $customfield['id'] }}">Görsel Ekle </label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group" id="icon-div_{{ $customfield['id'] }}">
                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                <button type="button" onclick="$('#modal_hidden_id').val({{ $customfield['id'] }})"  class="btn btn-default" value="" data-toggle="modal" data-target="#iconModal">Simge Ekle</button>
                                                        ...
                                                        <!-- End icone or image -->
                                            			<div class="form-group">
                                            				<label for="name_{{ $customfield['id'] }}">Alan Adı:</label>
                                            				<input id="name_{{ $customfield['id'] }}" name="name" type="text" value="{{ $customfield['name'] }}" class="form-control" required />
                                            			</div>
                                            			<div class="form-group">
                                            				<label for="type_{{ $customfield['id'] }}">Alan Türü:</label>
                                                            <select data-option="{{ $customfield['id'] }}" name="type" class="form-control show_options">
                                            					<option value="text" {{ (($customfield['type'] == 'text') ? 'selected' : '') }}>METİN</option>
                                            					<option value="textarea" {{ (($customfield['type'] == 'textarea') ? 'selected' : '') }}>METİN ALANI</option>
                                            					<option value="dropdown" {{ (($customfield['type'] == 'dropdown') ? 'selected' : '') }}>AÇILIR MENÜ</option>
                                            					...
                                            					<option value="date" {{ (($customfield['type'] == 'date') ? 'selected' : '') }}>TARİH</option>
                                            					<option value="dateinterval" {{ (($customfield['type'] == 'dateinterval') ? 'selected' : '') }}>TARİH ARALIĞI</option>
                                            					<option value="file" {{ (($customfield['type'] == 'file') ? 'selected' : '') }}>DOSYA</option>
                                            				</select>
                                            			</div>
                                            			...
                                            			{{--@if (isset($customfield['options']) && $customfield['options'] && ($customfield['type'] == 'dropdown' || $customfield['type'] == 'radio'))--}}
                                            				...
                                            				<label for="options_{{ $customfield['id'] }}">Alan Seçenekleri:</label>
                                    ...
                                    <div class="portlet-body">
                                        <form name="form" action="#" method="post" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                                ...
                                                <div class="form-group">
                                                    <label for="type">Alan Türü:</label>
                                                    <select data-option="0" name="type" class="form-control show_options">
                                                        <option value="text">METİN</option>
                                                        <option value="textarea">METİN ALANI</option>
                                                        <option value="dropdown">AÇILIR MENÜ</option>
                                                        <option value="radio">RADIO</option>
                                                        <option value="checkbox">CHECKBOX</option>
                                                        <option value="url">URL</option>
                                                        <option value="date">TARİH</option>
                                                        <option value="dateinterval">TARİH ARALIĞI</option>
                                                        <option value="file">DOSYA</option>
                                                    </select>
                                                </div>
                                                <div class="form-group options_0 hidden">
                                                    <label for="options_{{ '0' }}">Alan Seçenekleri:</label>
                                                    <input id="options_{{ '0' }}" name="options" type="text" class="form-control" />
                                                    <span class="help-block">Virgülle ayrılmış seçenekleri girin.</span>
                                                </div>

                                                <div class="form-group">
                                                    <label for="description_{{ '0' }}">Alan Açıklaması:</label>
                                                    <input id="description_{{ '0' }}" name="description" type="text"  placeholder="Alan açıklamasını girin" class="form-control" />
                                                </div>
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-success">
                                                        <input id="req" name="required_field" type="checkbox" value="1">
                                                        <label for="req" class="text-danger">Bu alan zorunlu</label>
                                                    </div>
                                                </div>
                                                <!-- Search -->
                                                <div class="form-group search_0 hidden">
                                                    <div class="checkbox checkbox-success">
                                                        ...
                                                        <label for="req_0" class="text-success">Bu alan, arama için eklensin mi?</label>
                                                    </div>
                                                </div>
                                                <!-- is shown in search under product  -->
                                                <div class="form-group shown_0">
                                                    <div class="checkbox checkbox-success">
                                                        ...
                                                        <label for="req_0" class="text-success">Bu alan, ilan listesi altında gösterilmek üzere eklensin mi?
                                                            <a href=""  data-toggle="modal" data-target="#modelExample">örneği kontrol et..</a></label>
                                                    </div>
                                                </div>
                                            <div class="form-group">
                                                <h5>Özelliği uygulamak istediğiniz kategorileri seçin:</h5>
                                                <div id="tree" class="tree-view">
                                                    {!! (isset($customfield_new['cat_tree_html']))? $customfield_new['cat_tree_html'] : '' !!}
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <p><a onclick="$('#advance').toggleClass('hidden')" href="javascript:void(0)"><b>Gelişmiş seçenekler</b></a></p>
                                                <div id="advance" class="hidden">
                                                    <div class="form-group">
                                                        <label for="">Veri Türü</label>
                                                        <select name="data_type" id="" class="form-control">
                                                            <option value="">-- Seçeneği Seçin --</option>
                                                            <option value="alpha_numeric">Alfasayısal</option>
                                                            <option value="alphabets">Yalnızca alfabeler</option>
                                                            <option value="numeric">Yalnızca sayısal</option>
                                                        </select>
                                                    </div>
                                                    <!--  -->
                                                    <div class="form-group">
                                                        <label for="">Kısaltmalar</label>
                                                        <input type="text" class="form-control"  name="inscription" placeholder="Örnek: Km, Kg">
                                                    </div>
                                                </div>
                                            </div>
                                            <br />
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="modelTitleId">Alanı açıklama örneği</h4>
                </div>
                <div class="modal-body">
