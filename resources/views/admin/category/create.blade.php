                ...
                <div class="card-box">
                    <div class="row">
                        <div class="col-xs-7 bg-white product-listing">
                            <!--   LIST       -->
                            <form id="add_category" method="post" role="form" enctype="multipart/form-data">
                                {{csrf_field()}}
                                @if(isset($category))
                                    <input type="hidden" name="hide_parent" value="y">
                                @endif
                                <input type="hidden" name="id" value="{{ ( isset($category) && $category->id != '')? $category->id: '' }}" id="id" >
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="">Başlık:</label>
                                                <input type="text" name="name" class="form-control" value="{{ ( isset($category) && $category->name != '')? $category->name: '' }}" id="title" placeholder="Kategori başlığı" required >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="radio radio-info radio-inline">
                                                    ...
                                                    <label for="is_icon">Simge ekle</label>
                                                </div>
                                                <div class="radio radio-inline">
                                                    <input type="radio" id="is_image" value="option2" name="switch">
                                                    <label for="is_image">Görsel Ekle </label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" id="icon-div">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-default" value="" data-toggle="modal" data-target="#iconModal">Simge ekle</button>
                                                    <button type="button" id="myicon" class="btn btn-primary {{ ($icon =='')? 'hidden' : '' }}"><?= ($icon !='')? '<i class="'.$icon.'"></i>' : '' ?></button>
                                                    <input type="hidden" name="icon" value="{{ ( isset($category) && $category->icon != '')? $category->icon: '' }}" id="icon_val" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select @if(!isset($category)) name="category" @endif id="category" class="form-control" {{ ( isset($category))? 'disabled': ''}}>
                                                    <option value="0">Üst kategori</option>
                                                    @foreach($cat as $value)
                                                    
                                                    
                                                    <option <?= ( isset($category) && $category->parent_id == $value['id'])? 'selected': ''; ?> value=" <?= $value['id']; ?>"> <?= $value['name'] ?></option> 
                                                  <!--  <option <?= ( isset($category) && $category->parent_id == $value['id'] && $value['parent_id']!=0 )? 'selected': ''; ?> value=" <?= $value['id']; ?>"> <?= $value['name'] ?></option> -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label">Fiyat Seçenekleri</label>
                                                <input type="text" name="price" value="{{ ( isset($category) && $price_option != '')? $price_option: '' }}" class="form-control" placeholder="yıl, ay, hafta, gün">
                                                <small>lütfen virgülle ayrılmış değerler ekleyin</small>
                                            </div>
                                        </div>
                                    </div>
