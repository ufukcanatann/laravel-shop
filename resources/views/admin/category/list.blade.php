@extends('admin.layout.app')@section('content')
    ...
    <div class="content-page">        <!-- Start content -->
        <div class="content">
            <div class="col-xs-12">
                <div class="page-title-box"><h4 class="page-title">Kontrol Paneli</h4>
                    ...
                    <div class="row">
                        <div class="btn-group pull-right m-b-10">
                            <button type="button" class="btn btn-primary waves-effect waves-light  dropdown-toggle"
                                    data-toggle="dropdown" aria-expanded="false"> Eylem <span class="caret"></span>
                            </button>
                            <ul class="dropdown-menu">
                                <li onclick="$('#catForm').submit()"><a href="javascript:void(0);"><i
                                                class="fa fa-trash" aria-hidden="true"></i> Öğeyi Sil </a></li>
                            </ul>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Kullanıcı Ekle/Düzenle</h4></div>
                <form id="add_category" method="post" role="form"><input type="hidden" name="id" value="" id="id">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group"><label for="">Başlık:</label> <input type="text" name="title"
                                                                                            class="form-control"
                                                                                            value="" id="name"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group"><label for="">Kategori:</label> <select name="category" id=""
                                                                                                class="form-control">
                                        <option value="0">Üst kategori</option> @foreach($cat as $value){
