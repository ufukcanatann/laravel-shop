    ...
    <div class="content">
        ...
        <div class="col-xs-12">
            ...
            <div class="card-box">
                <div class="row">
                    <div class="add_more">
                        <button type="button" class="btn btn-success waves-effect w-md waves-light" onclick='addUser()' >Kullanıcı Ekle</button>
                    </div>
        ...
        <div class="modal-content">
            ...
            <form id="add_user" method="post" role="form" >
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" value="" id="name" placeholder="isim" required >
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="email" name="email"  class="form-control" value="" id="email" placeholder="geçerli e-posta" required >
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="password"  class="form-control" value="" id="plain_password" placeholder="parola" required >
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">İptal Et</button>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modelTitleId">Kullanıcıyı Doğrula</h4>
            </div>
            <div class="modal-body">
                <center>
                    <!-- Ajax content here -->
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="checkIsVfy(this)" value="" id="ok" class="btn btn-primary">Doğrulandı</button>
                <button type="button" onclick="checkIsVfy(this)" value=""  id="err" class="btn btn-danger">Doğrulanmadı</button>
            </div>
        </div>
    </div>
</div>
