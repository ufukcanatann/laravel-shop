        ...
        <div class="content">
            <div class="col-xs-12">
                <div class="page-title-box">
                    <h4 class="page-title">Grup Ekle</h4>
                    <ol class="breadcrumb p-0 m-0">
                        <li> <a href="{{ url('dashboard') }}">Kontrol Paneli</a></li>
                        <li class="active">Grup Ekle </li>
                    </ol>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="">Grup Başlığı:</label>
                                                <input type="text" name="title" class="form-control" value="{{ ( isset($group) && $group->title != '')? $group->title: '' }}" id="title" placeholder="Grup başlığı" required >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
