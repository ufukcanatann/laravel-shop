            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-9 row page-content">
                        <div class="inner-box">
                            <h2 class="title-2"><i class="icon-docs"></i> Mesaj
                                ...
                                <div id="inboxed" class="tab-pane fade in active">
                                    ...
                                    <div class="inbox-widget nicescroll mx-box" tabindex="5000" style="overflow: hidden; outline: none;">
                                        @if(count($inbox) > 0 )
                                            ...
                                            @endforeach
                                        @else
                                            <p class="text-danger">Gelen kutusu boş.
                                                Henüz mesaj almadınız!  </p>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <h4 class="m-t-0 m-b-20 header-title"> <span class="whochat"></span> </h4>
