            ...
            <div class="row">
                <div class="col-md-9 page-content">
                    <div class="inner-box category-content">
                        <h2 class="title-2 uppercase"><strong> <i class="icon-docs"></i> Ücretsiz Seri İlan Verin</strong></h2>
                                    ...
                                    <div>
                                        ...
                                        <section>
                                            <div class="form-group col-md-12 clearfix">
                                                <label class=" control-label" for="userName2">Kategori <span class="text-danger">*</span></label>
                                            ...
                                            <div class="form-group col-md-12 clearfix">
                                                <label class=" control-label " for="title"> Başlık <span class="text-danger">*</span></label>
                                                ...
                                                <div class="row">
                                                    @if($setting->hide_price == 0)
                                                        <div class="col-md-12 clearfix">
                                                            <label class=" control-label " for="price">Fiyat <span class="text-danger">*</span></label>
                                                            ...
                                                            <small class="number_only">Sadece sayıya izin verilir!</small>
                                                        </div>
                                                    @endif
                                                    <div class="col-md-12 clearfix">
                                                        <div id="remaintime" style="display:none">
                                                            <label class=" control-label" for="price_container">Kalan Süre <span class="text-danger">*</span></label>
                                                            <input id="remaintiming" name="price" class="form-control"type="text" required onkeyup="check_number(this, 'number_only')" onpaste="check_number(this, 'number_only')" placeholder="sa:dk:sn">
                                                            <small class="number_only">Sadece süreye izin verilir!</small>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 clearfix"><br><br><input type="checkbox" name="artirmaonay" id="artirmaonay" value="0" /> Açık artırma ürünü olarak ekle</div>
                                                    
                                                    
                                                </div>
                                            </div>
                                            <div class="form-group  clearfix">
                                                <label class=" control-label m-l-10" for="confirm2">Açıklama <span class="text-danger">*</span></label>
                                        ...
                                        <!-- user information  -->
                                            <div class="guest">
                                                <div class="content-subheading"><i class="icon-user fa"></i> <strong>Satıcı bilgisi</strong></div>

                                                <div class="form-group clearfix m-b-10">
                                                    <label class="col-md-2 control-label" for="seller-name">İsim <span class="text-danger">*</span></label>
                                                    <div class="col-md-10">
                                                        <input id="seller-name"  @unless (!Auth::check()) readonly value="{{ ( isset($user->name) )? $user->name :  Auth::user()->name }}" @endunless name="user_name" placeholder="Satıcı İsmi" class="form-control input-md" required type="text">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        <div class="checkbox">
                                                            <label>
                                                                ...
                                                                <small> E-posta adresini ilanların girişinde görüntüleyin</small>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group clearfix m-b-10">
                                                    <label class="col-md-2 control-label" for="user_phone">Telefon <span class="text-danger">*</span></label>
                                                    <div class="col-md-8">
                                                        <input id="user_phone" name="phone" minlength="10" maxlength="15" @if($setting->mobile_verify != 1) onkeyup="check_number(this, 'phone_number_only')" @endif   placeholder="Telefon Numarası" @unless (!Auth::check()) @if(isset($user->phone) && $user->phone !='' ) value="{{$user->phone}}" disabled @else value="{{ Auth::user()->phone}}" @endif   @endunless class="@unless (!Auth::check()) {{ Auth::user()->mobile_verify ==1 ? 'vfy_phone_number' : '' }}  @endunless  form-control input-md " required type="text" autocomplete="off">
                                                        <small class="phone_number_only">Sadece sayıya izin verilir!</small>
                                                    </div>
                                                    @unless ( !Auth::check() )
                                                        @if( Auth::user()->mobile_verify !=1 )
                                                            <div class="col-md-2 hidden send_code_btn">
                                                                <button id="send_code" class="btn btn-success" type="button">Kodu gönder <i class="fa fa-spin fa-spinner hidden"></i></button>
                                                            </div>
                                                        @endif
                                                    @endunless
                                                </div>
                                        ...
                                        <section>
                                            <div class="form-group clearfix m-b-10">
                                                <label class="col-md-2 control-label" for="seller-Location">Posta Kodu</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" value="{{ (isset($ad_data['zip']) )? $ad_data['zip'] : '' }}" name="zip" autocomplete="off">
                                                    <small class="zip_number_only">Sadece sayıya izin verilir!</small>
                                                </div>
                                            </div>

                                            <div class="form-group clearfix m-b-10">
                                                <label class="col-md-2 control-label" for="seller-Location">Adres:</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="address" value="{{ (isset($ad_data['address']) )? $ad_data['address'] : '' }}" required>
                                                </div>
                                            </div>
                                            <div class="form-group clearfix m-b-10">
                                                <label class="col-md-2 control-label" for="seller-Location">Konum <span class="text-danger">*</span></label>
                                                <div class="col-md-10">
                                            ...
                                            <div id="load_city">
                                                ...
                                                @if(isset($ad_data))
                                                    <div class="form-group clearfix m-b-10">
                                                        <label class="col-md-2 control-label" for="seller-area">Şehir <span class="text-danger">*</span></label>
                                                        <div class="col-md-10">
                                            ...
                                            @if($setting->map_listings == 1)
                                                ...
                                                <div class="form-group clearfix m-l-15">
                                                    ...
                                                    <h4 class="m-t-0 header-title"><b>Konum Ekle</b></h4>
                                                    <div id="map"></div>
                                                    <input id="pac-input" type="text" class="form-control controls" placeholder="Konum Ara">
                                                </div>
                                            @endif
                                                    ...
                                                    <div class="form-group row">
                                                        <table id="featureTable" class="table table-hover checkboxtable">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><p><strong>${{ $featured->home_page_price }} </strong>{{ $featured->home_page_days }} günlük.</p></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <div class="form-check">
                                                                ...
                                                                <td><p><strong>${{ $featured->urgent_price }} </strong>{{ $featured->urgent_days }} günlük..</p></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <div class="form-check">
                                                                ...
                                                                <td><p><strong>${{ $featured->top_page_price }} </strong>{{ $featured->top_page_days }} günlük.</p></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="form-check-label">
                                                                            ...
                                                                            Sayfa Başı İlanı + Acil İlan
                                                                        </label>
                                                                    </div>

                                                                </td>
                                                                <td><p><strong>${{ $featured->urgent_top_price}} </strong>{{ $featured->urgent_top_days }} günlük.</p></td>
                                                            </tr>
                                                            <tr bgcolor="#ccc">
                                                                <td>
                                                                </td>
                                                                <td><p><strong>Ödenebilir miktar : ₺<span class="payableAmount">0</span></strong></p></td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                    ...
                                                    <div class="stripeGateway hidden">
                                                        ...
                                                        <div class='form-row'>
                                                            ...
                                                            <div class='col-md-4 col-xs-6 form-group expiration required'>
                                                                <label class='control-label'>Son Kullanma Ayı</label>
                                                                <input class='form-control card-expiry-month' placeholder='AA' size='2' value="" type='text' name="ccExpiryMonth">
                                                            </div>
                                                            <div class='col-md-4 col-xs-6 form-group expiration required'>
                                                                <label class='control-label'>Son Kullanma Yılı</label>
                ...
                <div class="col-md-3 reg-sidebar">
                    <div class="reg-sidebar-inner text-center">
                        <div class="promo-text-box"><i class=" icon-picture fa fa-4x icon-color-1"></i>
                            <h3><strong>Ücretsiz Seri İlan Gönderin</strong></h3>
                            <p> Ücretsiz çevrimiçi sınıflandırılmış reklamlarınızı bizimle paylaşın.</p>
                        </div>
                        <div class="panel sidebar-panel">
                            <div class="panel-heading uppercase">
                                <small><strong>Nasıl hızlı satış yapılır?</strong></small>
                            </div>
                            <div class="panel-content">
                                <div class="panel-body text-left">
                                    <ul class="list-check">
                                        <li> Öğenin kısa bir başlığını ve açıklamasını kullanın</li>
                                        <li> İlanınızı doğru kategoriye eklediğinizden emin olun</li>
                                        <li> İlanınıza güzel fotoğraflar ekleyin</li>
                                        <li> Makul bir fiyat belirleyin</li>
                                        <li> Yayınlamadan önce öğeyi kontrol edin</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="modelTitleId">Neden kayıt olmalısınız?</h4>
                </div>
                        ...
                        <div class="b-registration-info-container">
                            <div class="b-registration-info">
                                <div class="b-registration-info-title">
                                    Kayıt Olmanın Avantajları
                                </div>
                                <div class="b-registration-info-text">
                                    {{ \App\Setting::value('title') }} ilanlarınızı kolay ve hızlı bir şekilde yönetmek için tasarlanmış ücretsiz bir hizmettir.
                                    <ul class="b-rounded-list">
                                        <li>
                                            ...
                                            <div class="b-rounded-list-content">
                                                <div class="font-weight-bold">Hızlılık</div>
                                                <p>E-posta ile bildirim beklemeden ilanlarınızı yayınlayın</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="b-rounded-list-pointer">
                                            ...
                                            <div class="b-rounded-list-content">
                                                <div class="font-weight-bold">İstatistik</div>
                                                <p>İlanınızın performansını, ziyaret sayısını ve yanıtları analiz edin</p>
                                            </div>
                                        </li>
                                        <li class="b-last">
                                            <div class="b-rounded-list-pointer">
                                            ...
                                            <div class="b-rounded-list-content">
                                                <div class="font-weight-bold">Görünürlük</div>
                                                <p>Kredi Paketleri satın alarak ilanlarınızı tanıtın</p>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ url('register') }}" class="btn btn-danger btn-xl pull-left"><i class="icon-user-add"></i> Kayıt Ol</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <center><h3 class="modal-title text-center">Kayıtlı Kullanıcı</h3></center>
                </div>
                <div class="modal-body text-center">
                    <div class="p-25">
                        <p> Bulduk, zaten kayıtlısınız.</p>
                        <p>Giriş yapmak için parolanızı girin</p>
                        <form action="" id="LoginTop">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-success"> <i class="icon-login"></i> Oturum Aç </button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title">Kategori Seç <i class="fa fa-spin fa-spinner hidden"></i></h3>
                </div>
                <div class="modal-body">
                    <div class="p-25">
