        ...
        @foreach($fields as $v)
            ...
            if($v->type == 'date'){
                ...
                $date_picker_id .='#datepicker_'.$count.',';
                    ...
                    <div class=" m-b-155">
                        ...
                        <input type="text" class="form-control" name="'.$name.'" '.$required.' placeholder="aa/gg/yyyy" id="datepicker_'.$count.'" />
                        '.$endInscription.'
                    </div></div>
                    ';
                    $date .= $endFormGroup;
            ...
            if($v->type == 'dateinterval'){
                ...
                $daterange_picker_id .='#input-daterange_'.$count.',';
                    ...
                    <div class=" m-b-155">
                        <div class="input-icon"><i class="fa fa-calendar"></i>
                        <input type="text" class="form-control" name="'.$name.'" '.$required.' placeholder="aa/gg/yyyy" id="input-daterange_'.$count.'" />
                        '.$endInscription.'
                    </div></div>
                    ';
